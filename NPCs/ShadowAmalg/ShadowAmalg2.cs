...
{
    [AutoloadBossHead]
    public class ShadowAmalg2 : ModNPC
    {
		private int ai;
		...
		{
			DisplayName.SetDefault("Shayde, The Shadow Amalgamation");
		...
		public override void SetDefaults()
		{
			...
			music = mod.GetSoundSlot(SoundType.Music, "Sounds/Music/Amalg2");
		...
		{
			npc.lifeMax = 120000; /*(int)(npc.lifeMax * 0.75f * bossLifeScale);*/
			npc.damage = 230; /*(int)(npc.damage * 0.75f);*/
			npc.defense = 32;
		}
		...
		public override void AI()
		{
			...
			if (npc.ai[0] % 600 == 20)
			{
				NPC.NewNPC((int)npc.position.X, (int)npc.position.Y, NPCType<ShadowEnemy>());
			}
		}
		...
		public override void NPCLoot()
		{
			...
			{
				ImmortalWorld.downedShadowAmalg = true;
		...
		public override void OnHitPlayer(Player player, int damage, bool crit)
		{
			if (Main.rand.NextBool(2))
			{
				...
				player.AddBuff(BuffType<Buffs.Debuffs.DarkFlame>(), 300);
			}
		}

		public override bool CheckDead()
		{
			Main.NewText("I think I understand now. I shouldn't be doing this...", 255, 0, 0);
			return true;
		}
	}
}